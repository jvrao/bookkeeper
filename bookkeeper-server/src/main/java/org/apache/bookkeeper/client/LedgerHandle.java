...
public class LedgerHandle {
     ...
     * @return the entryId of the new inserted entry
     */
    long addEntry(final long entryId, byte[] data) throws InterruptedException, BKException {
     ...
     * @return entryId
     */
    long addEntry(final long entryId, byte[] data, int offset, int length) throws InterruptedException,
            BKException {
        LOG.error("To use this feature Ledger must be created with createLedgerAdv() interface.");
        throw BKException.create(BKException.Code.IllegalOpException);
    }
     ...
     *            some control object
     */
    void asyncAddEntry(final long entryId, final byte[] data, final AddCallback cb, final Object ctx)
            throws BKException {
        LOG.error("To use this feature Ledger must be created with createLedgerAdv() interface.");
